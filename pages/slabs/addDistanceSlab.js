...
import {addDistance,cityList} from '../../actions/distanceAction'
...
const AddDistance = () => {
   ...
   function edit(cell, row){
    ...
    const handleSubmit = e => {
        ...
        addDistance(chapter,token).then(data => {
            if (data.error) {
    ...
    return (
        ...
        <meta name="title" content='Add Distance' />
    ...
    <div className="row">
        <div className="col-12">
            <div className="page-title-box">
                <h4 className="page-title float-left">Add Distance</h4>

                <ol className="breadcrumb float-right">
                    <li className="breadcrumb-item"> <Link href='/dashboard'><a>Dashboard</a></Link></li>
                    <li className="breadcrumb-item active">Add Distance</li>
                </ol>
