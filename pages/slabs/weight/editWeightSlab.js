                ...
                getWeightById(token,_id).then(weight => {
                    if (weight.weight) {
                        ...
                        setValues({ ...values, 
                            ...
                            rate:weight.rate,
                            gst:weight.gst,
                            additional_gst:weight.additional_gst,
                            additional_rate:weight.additional_rate,
                            above:weight.above,
                            city_id:weight.city_id});

                            setTotal(weight.total);
                            setAdditionTotal(weight.additional_total);
    ...
    const handleSubmit = e => {
        ...
        editWeight(chapter,token,_id).then(data => {
            if (data.error) {
                ...
                Router.push(`/slabs/weight/weightSlab`);
            }
        });
...
<form role="form" onSubmit={handleSubmit}  >
    <div className="form-group">
        <label>From</label>
            <input type="text" className="form-control" value={from} placeholder="From in Kg" id="name" name="name" onChange={handleChange('from')} required />
        ...
        <select id='single' className="form-control" value={city_id} name="city_id" required id="sel1" onChange={handleCityChange('city_id')} >
                    ...
                    <div className="form-group">
                    <label>Additional Rate / Kg</label>
                   ...
                   <div className="form-group">
                   <label>To</label>
                   <input type="text" className="form-control" value={to} placeholder="To in Kg" id="name" name="name" onChange={handleChange('to')} required />
                    </div>
