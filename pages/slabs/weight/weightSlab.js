   ...
   function edit(cell, row){
    ...
    const iconformat=(cell, row)=>{ 
        ...
        const handleClick = e => {
            ...
            Router.push({
                pathname: '/slabs/weight/editWeightSlab',
                query: { _id: row._id },
            })
...
<div className="col-md-12">
    <div className="card-box">
            ...
            <div   style={{
                ...
                width: '98%'}}>
                        ...
                        <Link href='/slabs/weight/addWeightSlab'><a><span  className="btn waves-effect waves-light " style={{backgroundColor:"#38AF00"}}><i className="fe-plus"></i>  Add Weight Slab</span></a></Link>
                        </div>
                        <div className="col-md-2">
    ...
    <select id='single' className="form-control" value={city_id} name="city_id" required id="sel1" onChange={handleCityChange('city_id')} >
                ...
                {city.map((person, i) =>
                    ...
                    <TableHeaderColumn width='100px'  dataField='from' dataAlign="center"  dataSort> From (Kg) </TableHeaderColumn>
                    <TableHeaderColumn width='100px'  dataField='to' dataAlign="center" dataSort> To (Kg)</TableHeaderColumn>
